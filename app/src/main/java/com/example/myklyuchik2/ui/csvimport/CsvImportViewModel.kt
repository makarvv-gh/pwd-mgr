...
class CsvImportViewModel : ViewModel() {
    private val _importResult = MutableStateFlow<CsvImportResult>(CsvImportResult.Idle)
        ...
        viewModelScope.launch {
            try {
                ...
                try {
                    ...
                    // Update the UI state in MainViewModel directly
                    mainViewModel.uiState.value = mainViewModel.uiState.value.copy(
